      ...
      <div className="container-wide py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          <div className="md:col-span-4">
            ...
            <p className="mt-4 text-xs text-mrag-warm-white/25 leading-relaxed max-w-xs">
              HISCO 기반 통합 솔루션 기업.
          ...
          <div className="md:col-span-2">
            <span className="font-accent text-[10px] font-bold text-mrag-warm-white/15 uppercase tracking-[0.2em]">Navigate</span>
            <div className="mt-4 flex flex-col gap-2.5">
              {[
                ...
                <Link key={item.href} to={item.href} className="text-sm text-mrag-warm-white/30 hover:text-mrag-warm-white/60 transition-colors">
                  {item.label}
                </Link>
              ))}
            </div>
          ...
          <div className="md:col-span-3">
            <span className="font-accent text-[10px] font-bold text-mrag-warm-white/15 uppercase tracking-[0.2em]">Contact</span>
          ...
          <div className="md:col-span-3">
            <span className="font-accent text-[10px] font-bold text-mrag-warm-white/15 uppercase tracking-[0.2em]">Office</span>
            <p className="mt-4 text-sm text-mrag-warm-white/30 leading-relaxed">
              서울특별시 서초구 방배로 32길 4
              <br />정다원 빌딩 5F / B1
            </p>
            <a href="tel:02-308-0007" className="mt-2 block text-sm text-mrag-warm-white/30 font-accent hover:text-mrag-teal transition-colors">02-308-0007</a>
          </div>
        </div>

        <div className="mt-14 pt-6 border-t border-mrag-warm-white/[0.03] flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-[10px] text-mrag-warm-white/15 font-accent tracking-wider">
            © {new Date().getFullYear()} MRAG. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <p className="text-[10px] text-mrag-warm-white/10 font-accent tracking-[0.15em]">
              H · I · S · C · O
            </p>
            <button
              onClick={scrollToTop}
              className="text-[10px] text-mrag-warm-white/25 hover:text-mrag-teal transition-colors font-accent uppercase tracking-wider"
            >
              Top ↑
            </button>
          </div>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            ...
            <Reveal delay={0.3}>
              <div className="mt-10 flex gap-12">
                <div>
                  <span className="font-accent text-sm font-bold text-destructive/50 tracking-wider">기존 공간</span>
                  <p className="mt-1 font-accent text-xl font-extrabold text-destructive/40">Depreciation ↓</p>
                </div>
                <div>
          ...
          <div ref={chartRef}>
            <svg viewBox="0 0 500 300" className="w-full h-auto" fill="none">
              {[0, 1, 2, 3].map((i) => (
                <line key={i} x1="40" y1={50 + i * 70} x2="470" y2={50 + i * 70} stroke="hsl(36, 12%, 87%)" strokeWidth="0.5" />
              ))}
              <text x="32" y="57" textAnchor="end" fill="hsl(225,8%,50%)" fontSize="9" fontFamily="Inter Tight">가치</text>
              <text x="470" y="285" textAnchor="end" fill="hsl(225,8%,50%)" fontSize="9" fontFamily="Inter Tight">시간 →</text>
              ...
              <motion.circle cx="195" cy="155" r="4" fill="hsl(166, 56%, 40%)"
